...
function submit_date_filter() {
    ...
    var filtered_sighting_date=tableData.filter(filterbydate.bind(this,selected_date));
    //(ufo_data => ufo_data.datetime===selected_date)
    //filterbydate(inputValue));

    console.log(filtered_sighting_date);
};